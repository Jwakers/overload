...
export default function HomePage() {
  return (
    <main className="max-w-7xl flex flex-col justify-center mx-auto px-4 sm:px-6 lg:px-8 py-12 h-full bg-gradient-to-br from-brand/5 via-brand/10 to-brand/5">
      {/* Hero Section */}
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="text-center p-6">
          ...
          <p className="text-muted-foreground">
            Get powerful insights into your performance with detailed analytics
